...
We can see that age is approximately normal, while tumor size, regional node examined, regional node positive and survival months are skewed. We should do transformation on these four variables. Before the transformation, we can use the Box-Cox plot to check which transformation work the best for them.
